...
ActiveRecord::Schema.define(version: 20_170_829_120_809) do
  ...
  create_table 'authors_sources', id: false, force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8' do |t|
    ...
    t.index %w[source_id author_id], name: 'index_authors_sources_on_source_id_and_author_id', unique: true
  end
  ...
  create_table 'factors_words', id: false, force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8' do |t|
    ...
    t.index %w[factor_id word_id], name: 'index_factors_words_on_factor_id_and_word_id', unique: true
  end
  ...
  create_table 'references', id: false, force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8' do |t|
    ...
    t.index %w[reference_source_id source_id], name: 'index_references_on_reference_source_id_and_source_id', unique: true
    t.index %w[source_id reference_source_id], name: 'index_references_on_source_id_and_reference_source_id', unique: true
  end
  ...
  create_table 'synonyms_words', id: false, force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8' do |t|
    ...
    t.index %w[synonym_id word_id], name: 'index_synonyms_words_on_synonym_id_and_word_id', unique: true
  end
